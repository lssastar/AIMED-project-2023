...
plt.legend()
# plt.show()
plt.savefig('./docs/Resnet50_200_loss.png') ### 每次修改模型时，需要修改这里的文件名
...
plt.legend()
# plt.show()
plt.savefig('./docs/Resnet50_200_acc.png') ### 每次修改模型时，需要修改这里的文件名

# 保存模型
torch.save(net, save_dir + '/Resnet50_200.pth') ### 每次修改模型时，需要修改这里的文件名
...
# plt.show()
plt.savefig('./docs/Resnet50_200_confusion_matrix.png') ### 每次修改模型时，需要修改这里的文件名
...
# plt.show()
plt.savefig('./docs/Resnet50_200_ROC.png') ### 每次修改模型时，需要修改这里的文件名